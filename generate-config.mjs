  ...
  directories: [
    {
      ...
      name: "Directory/10",
      description:
        "Пользовательская документация: проектные описания, инструкции, чек-листы",
      description_en:
        "User documentation: project descriptions, instructions, checklists",
      required: false,
      excluded: false,
    },
    {
      ...
      name: "Directory/11",
      description:
        "Пользовательские функции: скрипты, расширения, пользовательские утилиты",
    ...
    },
    {
      ...
      name: "Directory/12",
      description:
        "Пользовательские файлы: исходники, шаблоны, проекты, пользовательские данные",
...
if (fs.existsSync(configPath)) {
  ...
  console.log(
    "💡 Для перезаписи удалите его вручную и запустите скрипт снова.",
  );
