...
export async function askValidated(
  ...
  errorMessage: string = '❌ Некорректный ввод. Пожалуйста, попробуйте снова.'
): Promise<string> {
...
export async function pressEnterToContinue(
  message: string = 'Нажмите Enter для продолжения...'
): Promise<void> {
 ...
 */
export async function askPassword(question: string = 'Введите пароль: '): Promise<string> {
