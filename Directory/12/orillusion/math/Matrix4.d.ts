...
export declare class Matrix4 {
     ...
     * @internal
     */
    static buffer: ArrayBuffer | ArrayBufferLike;
    /**
     * @internal
    ...
    * @param count every alloc matrix count
     ...
     */
    static fromToRotation(fromDirection: Vector3, toDirection: Vector3, target?: Matrix4, epsilon?: number): Matrix4;
    /**
     ...
     * @param epsilon tiny number
     */
    transformDir(fromDirection: Vector3, toDirection: Vector3, epsilon?: number): this;
    /**
     * multiply matrix a b
 ...
 * @returns {mat4} out
 */
export declare function matrixRotate(rad: number, axis: Vector3, target: Matrix4, epsilon?: number): FloatArray;
/**
 * @internal
 */
